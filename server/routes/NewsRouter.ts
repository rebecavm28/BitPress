...
import { deleteNews, getAllNews, createdNews, updateNews, showOneNews } from '../controllers/NewsController';
...
newsRouter.post('/news',isAuthenticated, rolAuthenticated(["user","admin"]),newsValidator,/* validateNews, */ createdNews);
