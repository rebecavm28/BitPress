...
newsRouter.post('/news',isAuthenticated, rolAuthenticated(["user","admin"]),newsValidator, createNews);
newsRouter.put('/news/:id', isAuthenticated,rolAuthenticated(["admin"]),newsValidator, updateNews);
